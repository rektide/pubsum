...
import type { ChapterContent } from "../plugin/epub.ts"
import type { OpencodeExtension, TokenUsage } from "../plugin/opencode.ts"

export interface SumPubConfig {
	outputPath: string | undefined
	contextLimit: number
	modelContextLimit: number
}

export interface SumPubDeps {
...
export class SumPubState {
	summary: string
	prevTokenTotal: number
	completedOrdinals: number[]
	sessionId: string | null
	readonly config: SumPubConfig
	readonly deps: SumPubDeps
